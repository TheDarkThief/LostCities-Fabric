...
public class CustomRegistryKeys {
    ...
    public static final RegistryKey<Registry<BuildingRE>> BUILDING_REGISTRY_KEY = RegistryKey.ofRegistry(Identifier.of(LostCities.MODID, "buildings"));
    ...
    public static final RegistryKey<Registry<PaletteRE>> PALETTE_REGISTRY_KEY = RegistryKey.ofRegistry(Identifier.of(LostCities.MODID, "palettes"));
    ...
    public static final RegistryKey<Registry<BuildingPartRE>> PART_REGISTRY_KEY = RegistryKey.ofRegistry(Identifier.of(LostCities.MODID, "parts"));
    ...
    public static final RegistryKey<Registry<StyleRE>> STYLE_REGISTRY_KEY = RegistryKey.ofRegistry(Identifier.of(LostCities.MODID, "styles"));
    ...
    public static final RegistryKey<Registry<ConditionRE>> CONDITIONS_REGISTRY_KEY = RegistryKey.ofRegistry(Identifier.of(LostCities.MODID, "conditions"));
    ...
    public static final RegistryKey<Registry<CityStyleRE>> CITYSTYLES_REGISTRY_KEY = RegistryKey.ofRegistry(Identifier.of(LostCities.MODID, "citystyles"));
    ...
    public static final RegistryKey<Registry<MultiBuildingRE>> MULTIBUILDINGS_REGISTRY_KEY = RegistryKey.ofRegistry(Identifier.of(LostCities.MODID, "multibuildings"));
    ...
    public static final RegistryKey<Registry<VariantRE>> VARIANTS_REGISTRY_KEY = RegistryKey.ofRegistry(Identifier.of(LostCities.MODID, "variants"));
    ...
    public static final RegistryKey<Registry<WorldStyleRE>> WORLDSTYLES_REGISTRY_KEY = RegistryKey.ofRegistry(Identifier.of(LostCities.MODID, "worldstyles"));
    ...
    public static final RegistryKey<Registry<PredefinedCityRE>> PREDEFINEDCITIES_REGISTRY_KEY = RegistryKey.ofRegistry(Identifier.of(LostCities.MODID, "predefinedcites"));
    ...
    public static final RegistryKey<Registry<PredefinedSphereRE>> PREDEFINEDSPHERES_REGISTRY_KEY = RegistryKey.ofRegistry(Identifier.of(LostCities.MODID, "predefinedspheres"));
    ...
    public static final RegistryKey<Registry<ScatteredRE>> SCATTERED_REGISTRY_KEY = RegistryKey.ofRegistry(Identifier.of(LostCities.MODID, "scattered"));
    ...
    public static final RegistryKey<Registry<StuffSettingsRE>> STUFF_REGISTRY_KEY = RegistryKey.ofRegistry(Identifier.of(LostCities.MODID, "stuff"));
