...
public class AssetRegistries {
    ...
    public static final RegistryAssetRegistry<StuffObject, StuffSettingsRE> STUFF = new RegistryAssetRegistry<>(CustomRegistryKeys.STUFF_REGISTRY_KEY, StuffObject::new);
