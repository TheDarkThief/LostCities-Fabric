...
public class ScatteredRE implements IAsset<ScatteredRE> {
    ...
    public static final Codec<ScatteredRE> CODEC = RecordCodecBuilder.create(instance ->
            instance.group(
                    ...
                    StringIdentifiable.createCodec(ScatteredBuilding.TerrainHeight::values).fieldOf("terrainheight").forGetter(l -> l.terrainheight),
                    StringIdentifiable.createCodec(ScatteredBuilding.TerrainFix::values).fieldOf("terrainfix").forGetter(l -> l.terrainfix),
